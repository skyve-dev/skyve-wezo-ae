...
describe('Property API Tests', () => {
  ...
  const createTestProperty = async () => {
    const propertyData = {
      ...
      // cancellation removed - now managed through rate plans
      ...
      // availability removed - managed separately
      // ratePlans removed - now managed through dedicated rate plan endpoints
      restrictions: [
        {
          type: 'NoArrivals',
          value: 1,
  ...
  // Pricing and cancellation test sections removed - now managed through rate plans
