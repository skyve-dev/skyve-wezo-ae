                ...
                <Box maxWidth="1400px" margin="0 auto" padding="0 2rem">
                    <Box textAlign="center" marginBottom="2rem">
                        ...
                        <Box fontSize="1.25rem" color="#6b7280" maxWidth="800px" margin="0 auto">
                            ...
                            in your property rental application. See layout systems, styling options, and interactive
                            behaviors.
                        </Box>
                    </Box>
                                    ...
                                    {Array.from({length: 6}, (_, i) => (
                                        ...
                                        >
                                            <Box
                                                ...
                                                color="white"
                                            >
                                                {[<FaUmbrellaBeach/>, <FaBuilding/>, <FaHome/>, <FaCity/>, <FaHome/>,
                                                    <FaBuilding/>][i]}
                                            </Box>
                                            <Box
                                                position="absolute"
                                ...
                                >
                                    ...
                                    >
                                        <Box>
                                            ...
                                            <Box fontSize="1rem" color="#6b7280">Welcome back to your property
                                                management</Box>
                                        </Box>
                                        <Box
                                            padding="0.75rem 1.5rem"
                    ...
                    <Box display="flex" flexDirection="column" gap="3rem">
                        <Box>
                            ...
                            <Box marginBottom="3rem">
                                ...
                                <Box display="grid" gridTemplateColumns="repeat(auto-fit, minmax(180px, 1fr))"
                                     gap="1rem">
                                    {[
                                        ...
                                        {name: 'Double', border: '4px double #8b5cf6'},
                                        {
                                            ...
                                            background: 'linear-gradient(white, white) padding-box, linear-gradient(45deg, #3182ce, #8b5cf6) border-box'
                                        }
                                    ].map((style, i) => (
                                        <Box
                                            key={i}
                                ...
                                >
                                    ...
                                    >
                                        {['Properties', 'Bookings', 'Analytics', 'Settings'].map((item) => (
                                            <Box key={item} color="#6b7280" cursor="pointer"
                                    ...
                                    {Array.from({length: 6}, (_, i) => (
                                        ...
                                        >
                                            <Box fontSize="2rem" marginBottom="0.5rem">
                                                {[<FaBullseye/>, <FaRocket/>, <FaStar/>, <FaPaintBrush/>, <FaBolt/>,
                                                    <FaTheaterMasks/>][i]}
                                            </Box>
                                            <Box fontSize="1rem" fontWeight="600" marginBottom="0.25rem">
                        ...
                        <Box>
                            ...
                            >
                                ...
                                <Box display="flex" flexDirection="column" gap="1.5rem">
                                    ...
                                    {/* Select */}
                                    <Box>
                                        <Box as="label" fontSize="1rem" fontWeight="500" marginBottom="0.5rem"
                                             display="block">
                                            Property Type *
                                        </Box>
                                        <Box
                                            ...
                                            {[
                                                {
                                                    value: 'instant',
                                                    label: 'Instant Book',
                                                    desc: 'Guests can book immediately'
                                                },
                                                {
                                                    value: 'request',
                                                ...
                                                >
                                                    <Box display="flex" alignItems="center" gap="0.75rem">
                                                        <Box as="input" type="radio" name="bookingType"
                                                             value={option.value}/>
                                                        <Box>
